...
add_action('wp_footer', function(){?>
    <script>
        ...
        setInterval(() => {
            ...
            $('.container-notification .container-meta-notification .date-notification').html(randomHour);
            $('.container-notification .container-meta-notification .location-notification').html(services[Math.floor(Math.random() * services.length)]);
            $('.container-notification').slideDown();
            setTimeout(() => {
